# Graph Report - thecallagent-site  (2026-05-26)
...
Cohesion: 0.07
Nodes (27): aP, aue(), bue(), cI(), cue(), Dce(), Do(), due() (+19 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (27): BB(), displayable(), dP(), e5(), fb(), ffe(), gle(), Hd() (+19 more)
...
Cohesion: 0.09
Nodes (24): aae(), Ase(), bO(), Cge(), dge(), DI(), dse(), eae() (+16 more)
...
- **Thin community `Community 34`** (2 nodes): `m1`, `.constructor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (2 nodes): `eP`, `.constructor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (2 nodes): `lB()`, `.constructor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (2 nodes): `Wf`, `.constructor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (2 nodes): `sp()`, `.constructor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `g1` connect `Community 5` to `Community 0`, `Community 17`, `Community 8`?**
