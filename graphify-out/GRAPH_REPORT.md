...
## Summary
- 1671 nodes · 5054 edges · 47 communities detected
...
- `jS()` --calls--> `Le()`  [EXTRACTED]
  cached-bundle.js → cached-bundle.js  _Bridges community 1 → community 24_
- `_()` --calls--> `i()`  [EXTRACTED]
...
Cohesion: 0.14
Nodes (16): a3(), _ae(), bbe(), bme(), eA(), hm(), Kme(), mB() (+8 more)
...
Cohesion: 0.2
Nodes (9): Cae(), eve(), Gme(), Gx(), kae(), LI(), tae(), tP() (+1 more)
...
- **Why does `g1` connect `Community 3` to `Community 1`, `Community 28`, `Community 9`?**
